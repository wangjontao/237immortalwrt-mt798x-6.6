...
make defconfig
grep -q '^CONFIG_TARGET_mediatek_filogic_DEVICE_cmcc_a10=y$' .config
 grep -q '^CONFIG_TARGET_mediatek_filogic_DEVICE_cmcc_a10_stock=y$' .config
 grep -q '^CONFIG_TARGET_mediatek_filogic_DEVICE_cmcc_a10_ubootmod=y$' .config
